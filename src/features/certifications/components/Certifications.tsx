...
import { AnimationPhase } from "../types/certification";
...
export function Certifications() {
  ...
  const currentCerts = CERTIFICATIONS.slice(
    displayPage * CERTS_PER_PAGE,
    (displayPage + 1) * CERTS_PER_PAGE
  );

  return (
    <section ref={ref} id="certifications" className="py-20 bg-gray-950 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
          <div>
            ...
            >
              Here are some of the professional certifications and credentials I&apos;ve earned.
            </p>
          </div>
