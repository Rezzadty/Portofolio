        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <a
              ...
              className="btn-primary w-full px-6 py-3 bg-emerald-500 text-black font-semibold rounded-lg hover:bg-emerald-400 transition-all inline-block text-center relative z-10"
            >
              Open Email Client
            </a>
